...
import com.btptraining.dbboot.util.SpringUtils;

@WebServlet(urlPatterns = { "/isha.svc/*" }

        , initParams = {
                @WebInitParam(name = "javax.ws.rs.Application", value = "org.apache.olingo.odata2.core.rest.app.ODataApplication"),
                @WebInitParam(name = "org.apache.olingo.odata2.service.factory", value = "com.btptraining.dbboot.processor.MyODataProcessor")
        }
...
public class BuilderODataServlet extends ODataServlet {
    ...
    private String oDataServiceFactoryBeanName = "com.btptraining.dbboot.processor.MyODataServiceFactory";
